...
function initializeProject()
{
   ...
   exec("~/gui/howToPlay.gui");
   exec("~/gui/pauseGui.gui");
   exec("~/gui/introAnim.gui");

   // Exec game scripts.
   exec("./gameScripts/game.cs");
   exec("./gameScripts/timer.cs");
   exec("./gameScripts/stack.cs");
   exec("./gameScripts/fillGrid.cs");
   exec("./gameScripts/fillButton.cs");
   exec("./gameScripts/button.cs");
   exec("./gameScripts/particleScore.cs");
   exec("./gameScripts/audio.cs");
   exec("./gameScripts/scoreboard.cs");
   exec("./gameScripts/userSettings.cs");
   exec("./gameScripts/orbitSelection.cs");
   exec("./gameScripts/fade.cs");
